...
public class MathClassExample {
	...
	public static void main(String[] args) {
		...
		System.out.println("v13 : " + v13);//double타입
		
		long v14 = Math.round(5.3);//소수점 첫째자리만 반올림
		...
		double v16 = temp2/ 100.0;//temp2가 정수타입이라서 .0 을 붙여줘야함
		System.out.println("v16 : "+ v16);//소수점 2자리 까지 나옴
		
		//rint()와 round()의 차이
		//rint()는 0.5(정중앙값)일때 짝수값으로 넘어감
