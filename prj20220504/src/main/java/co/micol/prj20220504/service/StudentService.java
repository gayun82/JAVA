...
public class StudentService {
	...
	private void dataSet() {
		...
		student = new StudentVO("park", "박승리", "컴퓨터공학", "대구광역시", "010-2222-2222", Date.valueOf("2000-02-01"));
		students.add(student);
		student = new StudentVO("kim", "이기자", "컴퓨터공학", "대구광역시", "010-3333-1111", Date.valueOf("2000-03-01"));
		students.add(student);
